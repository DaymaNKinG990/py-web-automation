...
class TestUiClientInit:
    ...
    @allure.title("TC-UI-002: Initialize UiClient with config=None uses default")
    @allure.description("Test that UiClient with config=None uses default Config. TC-UI-002")
    def test_init_with_config_none_uses_default(self):
        """Test that UiClient with config=None uses default Config. TC-UI-002"""
        with allure.step("Create UiClient with config=None"):
            ui = UiClient("https://example.com/app", None)

        with allure.step("Verify config is a default Config instance"):
    ...
    async def test_methods_before_browser_setup(self, ui_client_with_config, caplog):
        ...
        with allure.step("Test click_element before browser setup"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.click_element("#button")

        with allure.step("Test fill_input before browser setup"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.fill_input("#input", "text")

        with allure.step("Test wait_for_element before browser setup"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.wait_for_element("#element")

        with allure.step("Test get_element_text raises error when browser not set"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.get_element_text("#element")

        with allure.step("Test get_element_attribute_value raises error when browser not set"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.get_element_attribute_value("#element", "href")

        with allure.step("Test scroll_to_element returns None when browser not set"):
            await ui_client_with_config.scroll_to_element("#element")
            # Method returns None, no error raised

        with allure.step("Test hover_element returns None when browser not set"):
            await ui_client_with_config.hover_element("#element")
            # Method returns None, no error raised

        with allure.step("Test double_click_element returns None when browser not set"):
            await ui_client_with_config.double_click_element("#element")
            # Method returns None, no error raised

        with allure.step("Test right_click_element returns None when browser not set"):
            await ui_client_with_config.right_click_element("#element")
            # Method returns None, no error raised

        with allure.step("Test select_option returns None when browser not set"):
            await ui_client_with_config.select_option("#select", "option1")
            # Method returns None, no error raised

        with allure.step("Test check_checkbox returns None when browser not set"):
            await ui_client_with_config.check_checkbox("#checkbox")
            # Method returns None, no error raised

        with allure.step("Test uncheck_checkbox returns None when browser not set"):
            await ui_client_with_config.uncheck_checkbox("#checkbox")
            # Method returns None, no error raised

        with allure.step("Test upload_file returns None when browser not set"):
            await ui_client_with_config.upload_file("#file", "file.txt")
            # Method returns None, no error raised

        with allure.step("Test press_key returns None when browser not set"):
            await ui_client_with_config.press_key("Enter")
            # Method returns None, no error raised

        with allure.step("Test type_text returns None when browser not set"):
            await ui_client_with_config.type_text("text")
            # Method returns None, no error raised

        with allure.step("Test wait_for_navigation returns None when browser not set"):
            await ui_client_with_config.wait_for_navigation()
            # Method returns None, no error raised

        with allure.step("Test get_page_title returns empty string when browser not set"):
            result = await ui_client_with_config.get_page_title()
            assert result == ""  # Should return empty string when browser not set

        with allure.step("Test get_page_url returns empty string when browser not set"):
            result = await ui_client_with_config.get_page_url()
            assert result == ""  # Should return empty string when browser not set

        with allure.step("Test take_screenshot raises error when browser not set"):
            with pytest.raises(RuntimeError, match="Browser not initialized"):
                await ui_client_with_config.take_screenshot("screenshot.png")

        with allure.step("Test execute_script returns None when browser not set"):
            result = await ui_client_with_config.execute_script("return 1")
...
class TestUiClientClose:
    ...
    async def test_close_closes_browser_if_set(self, ui_client_with_browser):
        ...
        with allure.step("Save reference to browser before close()"):
            ...
            browser = ui_client_with_browser.browser
        with allure.step("Call close()"):
            await ui_client_with_browser.close()
    ...
    async def test_close_does_nothing_if_browser_none(self, ui_client_with_config):
        """Test close() does nothing if browser is None. TC-UI-007"""
        with allure.step("Call close() when browser is None"):
            # Should not raise any exception
            await ui_client_with_config.close()

        with allure.step("Verify browser remains None"):
            assert ui_client_with_config.browser is None
...
class TestUiClientSetupBrowser:
    ...
    async def test_setup_browser_first_call_launches_chromium(
        self, mocker, ui_client_with_config, mock_browser, mock_page
    ):
        """Test first call to setup_browser launches Chromium. TC-UI-003"""
        with allure.step("Mock async_playwright and browser setup"):
            mock_playwright_class = mocker.patch("py_web_automation.clients.ui_client.async_playwright")
            mock_playwright_instance = mocker.MagicMock()
            mock_playwright_instance.start = mocker.AsyncMock(return_value=mock_playwright_instance)
        ...
        with allure.step("Call setup_browser()"):
            result = await ui_client_with_config.setup_browser()

        with allure.step("Verify setup_browser returns self and sets browser/page"):
            assert result is ui_client_with_config  # Returns self
            assert ui_client_with_config.browser == mock_browser
            assert ui_client_with_config.page == mock_page
    ...
    async def test_setup_browser_creates_new_page(self, mocker, ui_client_with_config, mock_browser, mock_page):
        ...
        with allure.step("Call setup_browser()"):
            await ui_client_with_config.setup_browser()
    ...
    async def test_setup_browser_sets_user_agent(self, mocker, ui_client_with_config, mock_browser, mock_page):
    ...
    @allure.description("Test second call to setup_browser logs 'Browser already setup'. TC-UI-004")
    async def test_setup_browser_second_call_logs_already_setup(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Call setup_browser() second time"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.setup_browser()
    ...
    @allure.description("Test second call to setup_browser does not create new browser.")
    async def test_setup_browser_second_call_does_not_create_new_browser(self, ui_client_with_browser, mock_browser):
        """Test second call to setup_browser does not create new browser."""
        with allure.step("Save reference to original browser"):
            original_browser = ui_client_with_browser.browser
        ...
        with allure.step("Verify browser remains the same"):
            ...
            assert ui_client_with_browser.browser is original_browser

    @pytest.mark.asyncio
    @allure.title("setup_browser returns self for method chaining")
    @allure.description("Test setup_browser returns self for method chaining. TC-UI-005")
    async def test_setup_browser_returns_self(self, mocker, ui_client_with_config, mock_browser, mock_page):
        ...
        with allure.step("Verify setup_browser returns self"):
            assert result is ui_client_with_config
    ...
    async def test_setup_browser_rejects_empty_url(self, valid_config):
        ...
        with allure.step("Test with empty string URL"):
            # Test with empty string - BaseClient.__init__ now raises ValueError immediately
            with pytest.raises(ValueError, match="url cannot be empty"):
                _ = UiClient("", valid_config)

        with allure.step("Test with whitespace-only string URL"):
            # Test with whitespace-only string - BaseClient.__init__ now raises ValueError immediately
            with pytest.raises(ValueError, match="url cannot be empty"):
                _ = UiClient("   ", valid_config)

    @pytest.mark.asyncio
    @allure.title("setup_browser handles navigation failures gracefully")
    @allure.description("Test setup_browser handles navigation failures gracefully. TC-UI-043")
    async def test_setup_browser_handles_navigation_error(self, mocker, ui_client_with_config, mock_browser, mock_page):
        ...
        with allure.step("Mock async_playwright and browser setup"):
            ...
            mock_page.goto = mocker.AsyncMock(side_effect=PlaywrightTimeoutError("Navigation timeout"))
    ...
    @allure.description("Test setup_browser handles network errors during navigation. TC-UI-043")
    async def test_setup_browser_handles_network_error(self, mocker, ui_client_with_config, mock_browser, mock_page):
...
class TestUiClientElementInteraction:
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("selector", ["#submit", ".btn-primary", '[data-testid="input"]'])
    ...
    async def test_click_element_success(self, ui_client_with_browser, selector, caplog):
        """Test click_element logs DEBUG on success. TC-UI-008"""
        with allure.step(f"Click element with selector: {selector}"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.click_element(selector)

        with allure.step("Verify DEBUG log and click was called"):
            assert f"Clicked element: {selector}" in caplog.text
            ui_client_with_browser.page.click.assert_called_once_with(selector)

    @pytest.mark.asyncio
    @allure.title("click_element handles exceptions and logs ERROR")
    @allure.description("Test click_element handles exceptions and logs ERROR. TC-UI-009")
    async def test_click_element_exception_handled(self, mocker, ui_client_with_browser, caplog):
        """Test click_element handles exceptions and logs ERROR. TC-UI-009"""
        import pytest

        from py_web_automation.exceptions import NotFoundError

        with allure.step("Mock page.click to raise exception"):
            error = Exception("Element not found")
            ui_client_with_browser.page.click = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to click invalid element"):
            with caplog.at_level("ERROR"):
                with pytest.raises(NotFoundError, match="Failed to click element"):
                    await ui_client_with_browser.click_element("#invalid")
    ...
    @allure.description("Test click_element with unicode characters in selector. TC-UI-040")
    async def test_click_element_unicode_selector(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Click element with unicode selector"):
            ...
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.click_element(unicode_selector)

        with allure.step("Verify DEBUG log and click was called"):
            assert f"Clicked element: {unicode_selector}" in caplog.text
            ui_client_with_browser.page.click.assert_called_once_with(unicode_selector)
    ...
    async def test_click_element_very_long_selector(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Click element with long selector"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.click_element(long_selector)

        with allure.step("Verify DEBUG log and click was called"):
            assert f"Clicked element: {long_selector}" in caplog.text
            ui_client_with_browser.page.click.assert_called_once_with(long_selector)
    ...
    async def test_fill_input_unicode_selector(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Fill input with unicode selector"):
            ...
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.fill_input(unicode_selector, "test")

        with allure.step("Verify DEBUG log and fill was called"):
            assert "Filled input" in caplog.text
            ui_client_with_browser.page.fill.assert_called_once_with(unicode_selector, "test")
    ...
    async def test_fill_input_very_long_selector(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Fill input with long selector"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.fill_input(long_selector, "test")

        with allure.step("Verify DEBUG log and fill was called"):
            assert "Filled input" in caplog.text
            ui_client_with_browser.page.fill.assert_called_once_with(long_selector, "test")
    ...
    async def test_fill_input_success(self, ui_client_with_browser, caplog):
        """Test fill_input logs DEBUG on success. TC-UI-010"""
        with allure.step("Fill input field"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.fill_input("#input", "test text")

        with allure.step("Verify DEBUG log and fill was called"):
            assert "Filled input" in caplog.text
            ui_client_with_browser.page.fill.assert_called_once_with("#input", "test text")

    @pytest.mark.asyncio
    @allure.title("TC-UI-011: fill_input handles exceptions")
    @allure.description("Test fill_input handles exceptions. TC-UI-011")
    async def test_fill_input_exception_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock page.fill to raise exception"):
            error = Exception("Element not found")
            ui_client_with_browser.page.fill = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to fill invalid input"):
            with caplog.at_level("ERROR"):
                with pytest.raises(NotFoundError, match="Failed to fill input"):
                    await ui_client_with_browser.fill_input("#invalid", "text")
    ...
    async def test_right_click_element_exception_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Attempt to right click invalid element"):
            with caplog.at_level("ERROR"):
                await ui_client_with_browser.right_click_element("#invalid")
...
class TestUiClientWaitAndNavigation:
    ...
    async def test_wait_for_element_success(self, ui_client_with_browser, caplog):
        """Test wait_for_element waits for element to appear. TC-UI-012"""
        with allure.step("Wait for element to appear"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.wait_for_element("#element")

        with allure.step("Verify DEBUG log and wait_for_selector was called"):
            assert "Element appeared" in caplog.text
            ui_client_with_browser.page.wait_for_selector.assert_called_once_with("#element", timeout=5000)
    ...
    async def test_wait_for_element_timeout(self, mocker, ui_client_with_browser, caplog):
        """Test wait_for_element handles timeout. TC-UI-013"""
        import pytest

        from py_web_automation.exceptions import TimeoutError

        with allure.step("Mock wait_for_selector to raise TimeoutError"):
            error = PlaywrightTimeoutError("Timeout")
            ui_client_with_browser.page.wait_for_selector = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to wait for invalid element"):
            with caplog.at_level("ERROR"):
                with pytest.raises(TimeoutError, match="did not appear"):
                    await ui_client_with_browser.wait_for_element("#invalid", timeout=1000)
    ...
    async def test_wait_for_navigation_success(self, ui_client_with_browser, caplog):
        """Test wait_for_navigation waits for networkidle. TC-UI-029"""
        with allure.step("Wait for navigation"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.wait_for_navigation()

        with allure.step("Verify DEBUG log and wait_for_load_state was called"):
            assert "Navigation completed" in caplog.text
            ui_client_with_browser.page.wait_for_load_state.assert_called_once_with("networkidle", timeout=5000)
    ...
    async def test_wait_for_navigation_timeout(self, mocker, ui_client_with_browser, caplog):
        """Test wait_for_navigation handles timeout. TC-UI-030"""
        with allure.step("Mock wait_for_load_state to raise TimeoutError"):
            error = PlaywrightTimeoutError("Timeout")
            ui_client_with_browser.page.wait_for_load_state = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to wait for navigation with timeout"):
            with caplog.at_level("ERROR"):
                await ui_client_with_browser.wait_for_navigation(timeout=1000)
...
class TestUiClientGetData:
    ...
    @allure.description("Test get_element_text returns text if element found. TC-UI-014")
    async def test_get_element_text_success(self, ui_client_with_browser, caplog):
        """Test get_element_text returns text if element found. TC-UI-014"""
        with allure.step("Get element text"):
            with caplog.at_level("DEBUG"):
                result = await ui_client_with_browser.get_element_text("#element")
    ...
    @allure.description("Test get_element_text returns None if element not found. TC-UI-015")
    async def test_get_element_text_element_not_found(self, mocker, ui_client_with_browser):
        """Test get_element_text returns None if element not found. TC-UI-015"""
        with allure.step("Mock query_selector to return None"):
            ui_client_with_browser.page.query_selector = mocker.AsyncMock(return_value=None)

        with allure.step("Get element text for nonexistent element"):
            result = await ui_client_with_browser.get_element_text("#nonexistent")
    ...
    async def test_get_element_text_exception_handled(self, mocker, ui_client_with_browser, caplog):
        """Test get_element_text handles exceptions."""
        import pytest

        from py_web_automation.exceptions import OperationError

        with allure.step("Mock query_selector to raise exception"):
            error = Exception("Query failed")
            ui_client_with_browser.page.query_selector = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to get element text"):
            with caplog.at_level("ERROR"):
                with pytest.raises(OperationError, match="Failed to get element text"):
                    await ui_client_with_browser.get_element_text("#element")
    ...
    @allure.description("Test get_element_attribute_value returns attribute value. TC-UI-016")
    async def test_get_element_attribute_value_success(self, ui_client_with_browser, attribute, caplog):
        ...
        with allure.step(f"Get element attribute value for {attribute}"):
            with caplog.at_level("DEBUG"):
                result = await ui_client_with_browser.get_element_attribute_value("#element", attribute)
    ...
    @allure.description("Test get_element_attribute_value returns None if element not found. TC-UI-017")
    async def test_get_element_attribute_value_element_not_found(self, mocker, ui_client_with_browser):
        ...
        with allure.step("Get element attribute value for nonexistent element"):
            result = await ui_client_with_browser.get_element_attribute_value("#nonexistent", "value")
    ...
    async def test_get_element_attribute_value_exception_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Attempt to get element attribute value"):
            with caplog.at_level("ERROR"):
                with pytest.raises(OperationError, match="Failed to get element attribute"):
                    await ui_client_with_browser.get_element_attribute_value("#element", "value")
    ...
    async def test_get_page_title_success(self, mocker, ui_client_with_browser, caplog):
        """Test get_page_title returns page title. TC-UI-031"""
        with allure.step("Mock page.title to return title"):
            ui_client_with_browser.page.title = mocker.AsyncMock(return_value="Test Page")

        with allure.step("Get page title"):
            with caplog.at_level("DEBUG"):
                result = await ui_client_with_browser.get_page_title()
    ...
    async def test_get_page_title_exception_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock page.title to raise exception"):
            ...
            ui_client_with_browser.page.title = mocker.AsyncMock(side_effect=error)
    ...
    async def test_get_page_url_success(self, ui_client_with_browser, caplog):
        """Test get_page_url returns page URL. TC-UI-033"""
        with allure.step("Set page.url"):
            ui_client_with_browser.page.url = "https://example.com/app"

        with allure.step("Get page URL"):
            with caplog.at_level("DEBUG"):
                result = await ui_client_with_browser.get_page_url()
    ...
    async def test_get_page_url_exception_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock page.url property to raise exception"):
            ...
            type(ui_client_with_browser.page).url = mocker.PropertyMock(side_effect=Exception("Test exception"))
...
class TestUiClientScreenshotsAndFiles:
    ...
    async def test_take_screenshot_success(self, ui_client_with_browser, caplog):
        ...
        with allure.step("Create temporary directory and screenshot path"):
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                with allure.step("Take screenshot"):
                    with caplog.at_level("DEBUG"):
                        await ui_client_with_browser.take_screenshot(screenshot_path)

                with allure.step("Verify DEBUG log and screenshot was called"):
                    assert "Screenshot saved" in caplog.text
                    ui_client_with_browser.page.screenshot.assert_called_once_with(path=screenshot_path)

    @pytest.mark.asyncio
    @allure.title("TC-UI-036: take_screenshot handles error")
    @allure.description("Test take_screenshot handles error. TC-UI-036")
    async def test_take_screenshot_error_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock page.screenshot to raise exception"):
            ...
            ui_client_with_browser.page.screenshot = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to take screenshot with invalid path"):
            with caplog.at_level("ERROR"):
                with pytest.raises(OperationError, match="Screenshot failed"):
                    await ui_client_with_browser.take_screenshot("/invalid/path.png")
    ...
    async def test_upload_file_success(self, ui_client_with_browser, caplog):
        """Test upload_file calls set_input_files. TC-UI-026"""
        with allure.step("Upload file"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.upload_file("#file-input", "/fake/path.jpg")

        with allure.step("Verify DEBUG log and set_input_files was called"):
            assert "Uploaded file" in caplog.text
            ui_client_with_browser.page.set_input_files.assert_called_once_with("#file-input", "/fake/path.jpg")

    @pytest.mark.asyncio
    @allure.title("upload_file handles error")
    @allure.description("Test upload_file handles error.")
    async def test_upload_file_error_handled(self, mocker, ui_client_with_browser, caplog):
        """Test upload_file handles error."""
        with allure.step("Mock page.set_input_files to raise exception"):
            error = Exception("File not found")
            ui_client_with_browser.page.set_input_files = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to upload file to invalid element"):
            with caplog.at_level("ERROR"):
                await ui_client_with_browser.upload_file("#invalid", "/fake/path.jpg")
...
class TestUiClientKeyboardAndScripts:
    ...
    async def test_execute_script_success(self, mocker, ui_client_with_browser, caplog):
        """Test execute_script returns result. TC-UI-037"""
        with allure.step("Mock page.evaluate to return value"):
            ui_client_with_browser.page.evaluate = mocker.AsyncMock(return_value=42)

        with allure.step("Execute script"):
            with caplog.at_level("DEBUG"):
                result = await ui_client_with_browser.execute_script("return 42")
    ...
    async def test_execute_script_error_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock page.evaluate to raise exception"):
            ...
            ui_client_with_browser.page.evaluate = mocker.AsyncMock(side_effect=error)

        with allure.step("Attempt to execute script that throws error"):
            with caplog.at_level("ERROR"):
                result = await ui_client_with_browser.execute_script("throw 'err'")
...
class TestUiClientScroll:
    ...
    @allure.description("Test scroll_to_element calls scroll_into_view_if_needed. TC-UI-018")
    async def test_scroll_to_element_success(self, mocker, ui_client_with_browser, caplog):
        """Test scroll_to_element calls scroll_into_view_if_needed. TC-UI-018"""
        with allure.step("Scroll to element"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.scroll_to_element("#element")

        with allure.step("Verify DEBUG log and locator was called"):
            assert "Scrolled to element" in caplog.text
            ui_client_with_browser.page.locator.assert_called_once_with("#element")

    @pytest.mark.asyncio
    @allure.title("TC-UI-019: scroll_to_element handles error")
    @allure.description("Test scroll_to_element handles error. TC-UI-019")
    async def test_scroll_to_element_error_handled(self, mocker, ui_client_with_browser, caplog):
        ...
        with allure.step("Mock locator.scroll_into_view_if_needed to raise exception"):
            ...
            ui_client_with_browser.page.locator.return_value = mock_locator

        with allure.step("Attempt to scroll to invalid element"):
            with caplog.at_level("ERROR"):
                await ui_client_with_browser.scroll_to_element("#invalid")
...
class TestUiClientSafety:
    ...
    async def test_no_exceptions_propagated(self, mocker, ui_client_with_browser):
        """Test that exceptions are properly wrapped in framework exceptions."""
        import pytest

        from py_web_automation.exceptions import OperationError

        with allure.step("Mock page.click to raise exception"):
            # Methods should wrap exceptions in framework exceptions
            error = Exception("Test error")
            ui_client_with_browser.page.click = mocker.AsyncMock(side_effect=error)

        with allure.step("Call click_element and verify exception is wrapped"):
            # Should raise OperationError (framework exception), not raw Exception
            with pytest.raises(OperationError, match="Failed to click element"):
                await ui_client_with_browser.click_element("#element")

    @pytest.mark.asyncio
    @allure.title("Browser is closed in close()")
    @allure.description("Test browser is closed in close().")
    async def test_browser_closed_in_close(self, ui_client_with_browser):
    ...
    async def test_logs_contain_context(self, ui_client_with_browser, caplog):
        """Test logs contain context (selector, key, etc.)."""
        with allure.step("Perform actions that generate logs"):
            with caplog.at_level("DEBUG"):
                await ui_client_with_browser.click_element("#submit")
                await ui_client_with_browser.press_key("Enter")
    ...
    def test_logger_bound_to_class_name(self, ui_client_with_config):
        """Test logger is bound to UiClient class name."""
        with allure.step("Verify logger is initialized"):
            assert ui_client_with_config.logger is not None
...
class TestUiClientInheritance:
    ...
    async def test_setup_browser_returns_self_for_fluent_interface(
        ...
        with allure.step("Verify setup_browser returns self for method chaining"):
            ...
            assert result is ui_client_with_config
            # Can be chained
            assert await ui_client_with_config.setup_browser() is ui_client_with_config
