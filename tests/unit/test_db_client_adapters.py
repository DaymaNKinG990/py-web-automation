...
from py_web_automation.clients.db_adapters.mysql_adapter import MySQLAdapter
from py_web_automation.clients.db_adapters.postgresql_adapter import PostgreSQLAdapter
...
class TestPostgreSQLAdapterFunctional:
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-047: PostgreSQLAdapter connect() with asyncpg via connection_string")
    @allure.description("Test PostgreSQLAdapter connects using asyncpg with connection_string. TC-DB-047")
    async def test_postgresql_connect_asyncpg_connection_string(self, valid_config, mocker, mock_asyncpg_module):
    ...
    @allure.description("Test PostgreSQLAdapter connects using asyncpg with kwargs. TC-DB-048")
    async def test_postgresql_connect_asyncpg_kwargs(self, valid_config, mocker, mock_asyncpg_module):
        """Test PostgreSQLAdapter connects using asyncpg with kwargs."""
        with allure.step("Create PostgreSQLAdapter without connection_string, with kwargs"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
                host="localhost",
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-049: PostgreSQLAdapter connect() with psycopg via connection_string")
    @allure.description("Test PostgreSQLAdapter connects using psycopg with connection_string. TC-DB-049")
    async def test_postgresql_connect_psycopg_connection_string(self, valid_config, mocker, mock_psycopg_module):
        ...
        with allure.step("Mock psycopg.AsyncConnection.connect() to return mock connection"):
    ...
    @allure.description("Test PostgreSQLAdapter connects using psycopg with kwargs. TC-DB-050")
    async def test_postgresql_connect_psycopg_kwargs(self, valid_config, mocker, mock_psycopg_module):
        ...
        with allure.step("Verify psycopg.AsyncConnection.connect() called with correct parameters"):
            mock_connect.assert_called_once_with(
                host="localhost",
                port=5432,
                dbname="testdb",
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-053: PostgreSQLAdapter connect() when already connected (idempotency)")
    ...
    @allure.description("Test PostgreSQLAdapter executes SELECT query using asyncpg. TC-DB-054")
    async def test_postgresql_execute_query_asyncpg(self, valid_config, mocker):
        ...
        with allure.step("Call await adapter.execute_query('SELECT * FROM users WHERE id = $1', {'id': 1})"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = $1", {"id": 1})

        with allure.step("Verify connection.fetch() called with correct query and parameters"):
    ...
    @allure.description("Test PostgreSQLAdapter executes SELECT query using psycopg. TC-DB-055")
    async def test_postgresql_execute_query_psycopg(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Call await adapter.execute_query('SELECT * FROM users WHERE id = :id', {'id': 1})"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = :id", {"id": 1})

        with allure.step("Verify cursor.execute() called with correct query and params"):
            mock_cursor.execute.assert_called_once_with("SELECT * FROM users WHERE id = :id", {"id": 1})
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-056: PostgreSQLAdapter execute_query() with parameters (asyncpg)")
    @allure.description("Test PostgreSQLAdapter execute_query() handles parameters with asyncpg. TC-DB-056")
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-057: PostgreSQLAdapter execute_query() with parameters (psycopg)")
    @allure.description("Test PostgreSQLAdapter execute_query() handles parameters with psycopg. TC-DB-057")
    async def test_postgresql_execute_query_params_psycopg(self, valid_config, mocker, mock_db_cursor):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-058: PostgreSQLAdapter execute_query() with no results (asyncpg)")
    @allure.description("Test PostgreSQLAdapter execute_query() returns empty list with asyncpg. TC-DB-058")
    async def test_postgresql_execute_query_no_results_asyncpg(self, valid_config, mocker):
        ...
        with allure.step("Call await adapter.execute_query() with non-existent id"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = $1", {"id": 999})
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-059: PostgreSQLAdapter execute_query() with no results (psycopg)")
    @allure.description("Test PostgreSQLAdapter execute_query() returns empty list with psycopg. TC-DB-059")
    async def test_postgresql_execute_query_no_results_psycopg(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Call await adapter.execute_query() with non-existent id"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = :id", {"id": 999})
    ...
    @allure.description("Test PostgreSQLAdapter executes INSERT command using asyncpg. TC-DB-060")
    async def test_postgresql_execute_command_insert_asyncpg(self, valid_config, mocker):
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("INSERT INTO users (name) VALUES ($1)", {"name": "Test"})
    ...
    @allure.description("Test PostgreSQLAdapter executes INSERT command using psycopg. TC-DB-061")
    async def test_postgresql_execute_command_insert_psycopg(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("INSERT INTO users (name) VALUES (:name)", {"name": "Test"})

        with allure.step("Verify cursor.execute() called with correct command"):
            mock_cursor.execute.assert_called_once_with("INSERT INTO users (name) VALUES (:name)", {"name": "Test"})
    ...
    @allure.description("Test PostgreSQLAdapter executes UPDATE command using asyncpg. TC-DB-062")
    async def test_postgresql_execute_command_update_asyncpg(self, valid_config, mocker):
    ...
    @allure.description("Test PostgreSQLAdapter executes UPDATE command using psycopg. TC-DB-063")
    async def test_postgresql_execute_command_update_psycopg(self, valid_config, mocker, mock_db_cursor):
    ...
    @allure.description("Test PostgreSQLAdapter executes DELETE command using asyncpg. TC-DB-064")
    async def test_postgresql_execute_command_delete_asyncpg(self, valid_config, mocker):
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("DELETE FROM users WHERE id = $1", {"id": 1})
    ...
    @allure.description("Test PostgreSQLAdapter executes DELETE command using psycopg. TC-DB-065")
    async def test_postgresql_execute_command_delete_psycopg(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("DELETE FROM users WHERE id = :id", {"id": 1})
    ...
    @allure.description("Test PostgreSQLAdapter begins transaction with asyncpg. TC-DB-066")
    ...
    @allure.description("Test PostgreSQLAdapter begins transaction with psycopg. TC-DB-067")
    ...
    @allure.description("Test PostgreSQLAdapter commits transaction with asyncpg. TC-DB-068")
    ...
    @allure.description("Test PostgreSQLAdapter commits transaction with psycopg. TC-DB-069")
    ...
    @allure.description("Test PostgreSQLAdapter rolls back transaction with asyncpg. TC-DB-070")
    ...
    @allure.description("Test PostgreSQLAdapter rolls back transaction with psycopg. TC-DB-071")
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-072: PostgreSQLAdapter transaction() context manager with asyncpg")
    @allure.description("Test PostgreSQLAdapter transaction context manager with asyncpg. TC-DB-072")
    async def test_postgresql_transaction_context_asyncpg(self, valid_config, mocker):
        ...
        with allure.step("Use async with adapter.transaction()"):
            async with adapter.transaction():
                await adapter.execute_command("INSERT INTO users (name) VALUES ($1)", {"name": "Test"})
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-073: PostgreSQLAdapter transaction() context manager with psycopg")
    @allure.description("Test PostgreSQLAdapter transaction context manager with psycopg. TC-DB-073")
    async def test_postgresql_transaction_context_psycopg(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Use async with adapter.transaction()"):
            async with adapter.transaction():
                await adapter.execute_command("INSERT INTO users (name) VALUES (:name)", {"name": "Test"})
    ...
    @allure.description("Test PostgreSQLAdapter execute_query() auto-connects if not connected. TC-DB-074")
    async def test_postgresql_execute_query_auto_connect(self, valid_config, mocker):
        ...
        with allure.step("Mock connect() and connection.fetch()"):
            mock_connect = mocker.patch.object(adapter, "connect", new_callable=AsyncMock)
            mock_connection = AsyncMock()
            mock_row = MagicMock()
    ...
    @allure.description("Test PostgreSQLAdapter execute_command() auto-connects if not connected. TC-DB-075")
    async def test_postgresql_execute_command_auto_connect(self, valid_config, mocker):
        ...
        with allure.step("Call await adapter.execute_command('INSERT INTO users VALUES (1)')"):
    ...
    @allure.description("Test PostgreSQLAdapter execute_query() handles None params. TC-DB-076")
    ...
    @allure.description("Test PostgreSQLAdapter execute_command() handles None params. TC-DB-077")
...
class TestMySQLAdapterFunctional:
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-078: MySQLAdapter connect() with aiomysql via connection_string")
    @allure.description("Test MySQLAdapter connects using aiomysql with connection_string. TC-DB-078")
    async def test_mysql_connect_aiomysql_connection_string(self, valid_config, mocker, mock_aiomysql_module):
    ...
    @allure.description("Test MySQLAdapter connects using aiomysql with kwargs. TC-DB-079")
    async def test_mysql_connect_aiomysql_kwargs(self, valid_config, mocker, mock_aiomysql_module):
    ...
    @allure.description("Test MySQLAdapter connects using pymysql with kwargs. TC-DB-080")
    async def test_mysql_connect_pymysql_kwargs(self, valid_config, mocker, mock_pymysql_module):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-083: MySQLAdapter connect() when already connected (idempotency)")
    ...
    @allure.description("Test MySQLAdapter executes SELECT query using aiomysql. TC-DB-084")
    async def test_mysql_execute_query_aiomysql(self, valid_config, mocker, mock_aiomysql_module, mock_db_cursor):
        ...
        with allure.step("Mock cursor.execute() and cursor.fetchall()"):
            mock_cursor = mock_db_cursor
            mock_cursor.fetchall = AsyncMock(return_value=[{"id": 1, "name": "Test"}, {"id": 2, "name": "Test2"}])
        ...
        with allure.step("Call await adapter.execute_query('SELECT * FROM users WHERE id = %s', {'id': 1})"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = %s", {"id": 1})

        with allure.step("Verify cursor.execute() called with correct query and parameters"):
    ...
    @allure.description("Test MySQLAdapter executes SELECT query using pymysql. TC-DB-085")
    async def test_mysql_execute_query_pymysql(self, valid_config, mocker, mock_pymysql_module):
        ...
        with allure.step("Mock cursor.execute() and cursor.fetchall() via executor"):
            ...
            mock_cursor.fetchall = MagicMock(return_value=[{"id": 1, "name": "Test"}, {"id": 2, "name": "Test2"}])
            mock_cursor.__enter__ = MagicMock(return_value=mock_cursor)
            mock_cursor.__exit__ = MagicMock(return_value=None)
            mock_connection.cursor = MagicMock(return_value=mock_cursor)
            mock_loop = MagicMock()
            mock_loop.run_in_executor = AsyncMock(return_value=[{"id": 1, "name": "Test"}, {"id": 2, "name": "Test2"}])
            mocker.patch(
                "asyncio.get_event_loop",
                return_value=mock_loop,
            )
    ...
    @allure.description("Test MySQLAdapter execute_query() handles parameters with aiomysql. TC-DB-086")
    ...
    @allure.description("Test MySQLAdapter execute_query() handles parameters with pymysql. TC-DB-087")
    async def test_mysql_execute_query_params_pymysql(self, valid_config, mocker, mock_pymysql_module):
        ...
        with allure.step("Mock cursor.execute() and cursor.fetchall() via executor"):
            mock_loop = MagicMock()
            mock_loop.run_in_executor = AsyncMock(return_value=[{"id": 1, "name": "Test"}])
            mocker.patch(
                "asyncio.get_event_loop",
                return_value=mock_loop,
            )
    ...
    @allure.description("Test MySQLAdapter execute_query() returns empty list with aiomysql. TC-DB-088")
    async def test_mysql_execute_query_no_results_aiomysql(
        ...
        with allure.step("Call await adapter.execute_query() with non-existent id"):
            result = await adapter.execute_query("SELECT * FROM users WHERE id = %s", {"id": 999})
    ...
    @allure.description("Test MySQLAdapter execute_query() returns empty list with pymysql. TC-DB-089")
    async def test_mysql_execute_query_no_results_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter executes INSERT command using aiomysql. TC-DB-090")
    async def test_mysql_execute_command_insert_aiomysql(
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("INSERT INTO users (name) VALUES (%s)", {"name": "Test"})
    ...
    @allure.description("Test MySQLAdapter executes INSERT command using pymysql. TC-DB-091")
    async def test_mysql_execute_command_insert_pymysql(self, valid_config, mocker, mock_pymysql_module):
        ...
        with allure.step("Mock pymysql module and cursor.execute()"):
            # Use fixture for mock pymysql module
            # Fixture already patches pymysql
    ...
    @allure.description("Test MySQLAdapter executes UPDATE command using aiomysql. TC-DB-092")
    ...
    @allure.description("Test MySQLAdapter executes UPDATE command using pymysql. TC-DB-093")
    async def test_mysql_execute_command_update_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter executes DELETE command using aiomysql. TC-DB-094")
    async def test_mysql_execute_command_delete_aiomysql(
        ...
        with allure.step("Call await adapter.execute_command()"):
            result = await adapter.execute_command("DELETE FROM users WHERE id = %s", {"id": 1})
    ...
    @allure.description("Test MySQLAdapter executes DELETE command using pymysql. TC-DB-095")
    async def test_mysql_execute_command_delete_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    async def test_mysql_begin_transaction_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter commits transaction with aiomysql. TC-DB-098")
    ...
    async def test_mysql_commit_transaction_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter rolls back transaction with aiomysql. TC-DB-100")
    ...
    @allure.description("Test MySQLAdapter rolls back transaction with pymysql. TC-DB-101")
    async def test_mysql_rollback_transaction_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter transaction context manager with aiomysql. TC-DB-102")
    async def test_mysql_transaction_context_aiomysql(self, valid_config, mocker, mock_db_cursor):
        ...
        with allure.step("Use async with adapter.transaction()"):
            async with adapter.transaction():
                await adapter.execute_command("INSERT INTO users (name) VALUES (%s)", {"name": "Test"})
    ...
    @allure.description("Test MySQLAdapter transaction context manager with pymysql. TC-DB-103")
    async def test_mysql_transaction_context_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @allure.description("Test MySQLAdapter execute_query() auto-connects if not connected. TC-DB-104")
    async def test_mysql_execute_query_auto_connect(self, valid_config, mocker, mock_aiomysql_module, mock_db_cursor):
    ...
    @allure.description("Test MySQLAdapter execute_command() auto-connects if not connected. TC-DB-105")
    async def test_mysql_execute_command_auto_connect(self, valid_config, mocker, mock_aiomysql_module, mock_db_cursor):
    ...
    @allure.description("Test MySQLAdapter execute_query() handles None params. TC-DB-106")
    async def test_mysql_execute_query_none_params(self, valid_config, mocker, mock_aiomysql_module, mock_db_cursor):
    ...
    @allure.description("Test MySQLAdapter execute_command() handles None params. TC-DB-107")
    async def test_mysql_execute_command_none_params(self, valid_config, mocker, mock_aiomysql_module, mock_db_cursor):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-108: MySQLAdapter execute_command() in transaction (doesn't auto-commit)")
    @allure.description("Test MySQLAdapter execute_command() doesn't auto-commit in transaction. TC-DB-108")
    async def test_mysql_execute_command_in_transaction(self, valid_config, mocker, mock_db_cursor):
        """Test MySQLAdapter execute_command() doesn't auto-commit in transaction."""
        with allure.step("Create and connect MySQLAdapter with transaction in progress"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
                connection_string="mysql://user:pass@localhost/db",
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-109: MySQLAdapter _detect_adapter() when neither aiomysql nor pymysql available")
    @allure.description(
    ...
    async def test_mysql_detect_adapter_no_libraries(self, valid_config, mocker):
        ...
        with allure.step("Verify ImportError is raised with appropriate message"):
            assert "MySQL adapter requires either 'aiomysql' or 'pymysql' library" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-110: MySQLAdapter begin_transaction() auto-connect for pymysql")
    @allure.description(
        "Test MySQLAdapter begin_transaction() automatically connects when not connected (pymysql). TC-DB-110"
    )
    async def test_mysql_begin_transaction_auto_connect_pymysql(self, valid_config, mocker, mock_pymysql_module):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-111: MySQLAdapter begin_transaction() auto-connect for aiomysql")
    @allure.description(
        "Test MySQLAdapter begin_transaction() automatically connects when not connected (aiomysql). TC-DB-111"
    )
    async def test_mysql_begin_transaction_auto_connect_aiomysql(self, valid_config, mocker, mock_aiomysql_module):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-112: PostgreSQLAdapter _detect_adapter() when neither asyncpg nor psycopg available")
    @allure.description(
    ...
    async def test_postgresql_detect_adapter_no_libraries(self, valid_config, mocker):
        ...
        with allure.step("Verify ImportError is raised with appropriate message"):
            assert "PostgreSQL adapter requires either 'asyncpg' or 'psycopg' library" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-113: PostgreSQLAdapter begin_transaction() auto-connect for asyncpg")
    @allure.description(
        "Test PostgreSQLAdapter begin_transaction() automatically connects when not connected (asyncpg). TC-DB-113"
    )
    async def test_postgresql_begin_transaction_auto_connect_asyncpg(self, valid_config, mocker):
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-114: PostgreSQLAdapter begin_transaction() auto-connect for psycopg")
    @allure.description(
        "Test PostgreSQLAdapter begin_transaction() automatically connects when not connected (psycopg). TC-DB-114"
    )
    async def test_postgresql_begin_transaction_auto_connect_psycopg(self, valid_config, mocker):
...
# ============================================================================
# MySQLAdapter Error Handling Tests
# ============================================================================


class TestMySQLAdapterErrorHandling:
    """Test MySQLAdapter error handling for RuntimeError scenarios."""

    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-ERROR-001: MySQLAdapter _execute_query_pymysql с RuntimeError")
    @allure.description(
        "Test _execute_query_pymysql raises RuntimeError when connection is None. TC-DB-MYSQL-ERROR-001"
    )
    async def test_mysql_execute_query_pymysql_runtime_error(self, valid_config, mocker, mock_pymysql_module):
        """Test _execute_query_pymysql raises RuntimeError when connection is None."""
        with allure.step("Create MySQLAdapter with pymysql"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
                connection_string="mysql://user:pass@localhost/db",
        ...
        with allure.step("Call await adapter._execute_query_pymysql()"):
            with pytest.raises(RuntimeError) as exc_info:
                await adapter._execute_query_pymysql("SELECT 1", None)

        with allure.step("Verify RuntimeError raised"):
            assert "Connection is not established" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-ERROR-002: MySQLAdapter _execute_command_pymysql с RuntimeError")
    @allure.description(
        "Test _execute_command_pymysql raises RuntimeError when connection is None. TC-DB-MYSQL-ERROR-002"
    )
    async def test_mysql_execute_command_pymysql_runtime_error(self, valid_config, mocker, mock_pymysql_module):
        """Test _execute_command_pymysql raises RuntimeError when connection is None."""
        with allure.step("Create MySQLAdapter with pymysql"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
        ...
        with allure.step("Call await adapter._execute_command_pymysql()"):
            with pytest.raises(RuntimeError) as exc_info:
                await adapter._execute_command_pymysql("INSERT INTO users VALUES (1)", None)

        with allure.step("Verify RuntimeError raised"):
            assert "Connection is not established" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-ERROR-003: MySQLAdapter begin_transaction с RuntimeError для pymysql")
    @allure.description(
        "Test begin_transaction raises RuntimeError when connection is None (pymysql). TC-DB-MYSQL-ERROR-003"
    )
    async def test_mysql_begin_transaction_runtime_error_pymysql(self, valid_config, mocker):
        """Test begin_transaction raises RuntimeError when connection is None (pymysql)."""
        with allure.step("Create MySQLAdapter with pymysql"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-ERROR-004: MySQLAdapter commit_transaction с RuntimeError для pymysql")
    @allure.description(
        "Test commit_transaction raises RuntimeError when connection is None (pymysql). TC-DB-MYSQL-ERROR-004"
    )
    async def test_mysql_commit_transaction_runtime_error_pymysql(self, valid_config, mocker):
        """Test commit_transaction raises RuntimeError when connection is None (pymysql)."""
        with allure.step("Create MySQLAdapter with pymysql"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-ERROR-005: MySQLAdapter rollback_transaction с RuntimeError для pymysql")
    @allure.description(
        "Test rollback_transaction raises RuntimeError when connection is None (pymysql). TC-DB-MYSQL-ERROR-005"
    )
    async def test_mysql_rollback_transaction_runtime_error_pymysql(self, valid_config, mocker):
        """Test rollback_transaction raises RuntimeError when connection is None (pymysql)."""
        with allure.step("Create MySQLAdapter with pymysql"):
            adapter = MySQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-MYSQL-FALLBACK-001: MySQLAdapter полный fallback сценарий")
    @allure.description("Test MySQLAdapter fallback from aiomysql to pymysql. TC-DB-MYSQL-FALLBACK-001")
    async def test_mysql_fallback_aiomysql_to_pymysql(self, valid_config, mocker, mock_pymysql_module):
        """Test MySQLAdapter fallback from aiomysql to pymysql."""
        with allure.step("Mock aiomysql import to raise ImportError"):
            original_import = builtins.__import__
        ...
        with allure.step("Verify _adapter_type is 'pymysql'"):
            adapter_type = adapter._detect_adapter()
            assert adapter_type == "pymysql"

        with allure.step("Mock pymysql.connect()"):
            mock_pymysql_data = mock_pymysql_module
            _ = mock_pymysql_data["connection"]
            _ = mock_pymysql_data["connect"]

        with allure.step("Connect to database"):
            await adapter.connect()

        with allure.step("Verify pymysql.connect() called"):
            assert adapter._adapter_type == "pymysql"
            assert adapter._connection is not None


# ============================================================================
# PostgreSQLAdapter Error Handling Tests
# ============================================================================


class TestPostgreSQLAdapterErrorHandling:
    """Test PostgreSQLAdapter error handling for RuntimeError scenarios."""

    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-001: PostgreSQLAdapter _execute_query_psycopg с RuntimeError")
    @allure.description("Test _execute_query_psycopg raises RuntimeError when connection is None. TC-DB-PG-ERROR-001")
    async def test_postgresql_execute_query_psycopg_runtime_error(self, valid_config, mocker, mock_psycopg_module):
        """Test _execute_query_psycopg raises RuntimeError when connection is None."""
        with allure.step("Create PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
                connection_string="postgresql://user:pass@localhost/db",
        ...
        with allure.step("Call await adapter._execute_query_psycopg()"):
            with pytest.raises(RuntimeError) as exc_info:
                await adapter._execute_query_psycopg("SELECT 1", None)

        with allure.step("Verify RuntimeError raised"):
            assert "Connection is not established" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-002: PostgreSQLAdapter _execute_query_psycopg с cursor.description is None")
    @allure.description(
        "Test _execute_query_psycopg returns empty list when cursor.description is None. TC-DB-PG-ERROR-002"
    )
    async def test_postgresql_execute_query_psycopg_description_none(self, valid_config, mocker, mock_psycopg_module):
        """Test _execute_query_psycopg returns empty list when cursor.description is None."""
        with allure.step("Create and connect PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
            ...
            # Mock connection and cursor as async context manager
            mock_cursor = mocker.AsyncMock()
            mock_cursor.description = None
            mock_cursor.execute = mocker.AsyncMock()
            mock_cursor.fetchall = mocker.AsyncMock(return_value=[])

            mock_connection = mocker.AsyncMock()
            # Make cursor() return an async context manager
            mock_cursor_context = mocker.AsyncMock()
            mock_cursor_context.__aenter__ = mocker.AsyncMock(return_value=mock_cursor)
            mock_cursor_context.__aexit__ = mocker.AsyncMock(return_value=None)
            mock_connection.cursor = mocker.Mock(return_value=mock_cursor_context)
            adapter._connection = mock_connection

        with allure.step("Call await adapter._execute_query_psycopg()"):
            result = await adapter._execute_query_psycopg("SELECT 1", None)

        with allure.step("Verify empty list returned"):
            assert result == []

    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-003: PostgreSQLAdapter _execute_command_psycopg с RuntimeError")
    @allure.description("Test _execute_command_psycopg raises RuntimeError when connection is None. TC-DB-PG-ERROR-003")
    async def test_postgresql_execute_command_psycopg_runtime_error(self, valid_config, mocker, mock_psycopg_module):
        """Test _execute_command_psycopg raises RuntimeError when connection is None."""
        with allure.step("Create PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
        ...
        with allure.step("Call await adapter._execute_command_psycopg()"):
            with pytest.raises(RuntimeError) as exc_info:
                await adapter._execute_command_psycopg("INSERT INTO users VALUES (1)", None)

        with allure.step("Verify RuntimeError raised"):
            assert "Connection is not established" in str(exc_info.value)

    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-004: PostgreSQLAdapter begin_transaction с RuntimeError для psycopg")
    @allure.description(
        "Test begin_transaction raises RuntimeError when connection is None (psycopg). TC-DB-PG-ERROR-004"
    )
    async def test_postgresql_begin_transaction_runtime_error_psycopg(self, valid_config, mocker):
        """Test begin_transaction raises RuntimeError when connection is None (psycopg)."""
        with allure.step("Create PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-005: PostgreSQLAdapter commit_transaction с RuntimeError для psycopg")
    @allure.description(
        "Test commit_transaction raises RuntimeError when connection is None (psycopg). TC-DB-PG-ERROR-005"
    )
    async def test_postgresql_commit_transaction_runtime_error_psycopg(self, valid_config, mocker):
        """Test commit_transaction raises RuntimeError when connection is None (psycopg)."""
        with allure.step("Create PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-ERROR-006: PostgreSQLAdapter rollback_transaction с RuntimeError для psycopg")
    @allure.description(
        "Test rollback_transaction raises RuntimeError when connection is None (psycopg). TC-DB-PG-ERROR-006"
    )
    async def test_postgresql_rollback_transaction_runtime_error_psycopg(self, valid_config, mocker):
        """Test rollback_transaction raises RuntimeError when connection is None (psycopg)."""
        with allure.step("Create PostgreSQLAdapter with psycopg"):
            adapter = PostgreSQLAdapter(
                "https://example.com/app",
                valid_config,
    ...
    @pytest.mark.asyncio
    @allure.title("TC-DB-PG-FALLBACK-001: PostgreSQLAdapter полный fallback сценарий")
    @allure.description("Test PostgreSQLAdapter fallback from asyncpg to psycopg. TC-DB-PG-FALLBACK-001")
    async def test_postgresql_fallback_asyncpg_to_psycopg(self, valid_config, mocker, mock_psycopg_module):
        """Test PostgreSQLAdapter fallback from asyncpg to psycopg."""
        with allure.step("Mock asyncpg import to raise ImportError"):
            original_import = builtins.__import__
        ...
        with allure.step("Verify _adapter_type is 'psycopg'"):
            adapter_type = adapter._detect_adapter()
            assert adapter_type == "psycopg"

        with allure.step("Mock psycopg.AsyncConnection.connect()"):
            mock_psycopg_data = mock_psycopg_module
            _ = mock_psycopg_data["connection"]
            _ = mock_psycopg_data["connect"]

        with allure.step("Connect to database"):
            await adapter.connect()

        with allure.step("Verify psycopg.AsyncConnection.connect() called"):
            assert adapter._adapter_type == "psycopg"
            assert adapter._connection is not None
