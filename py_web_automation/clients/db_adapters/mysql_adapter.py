...
class MySQLAdapter(DBClient):
    ...
    async def _connect_aiomysql(self) -> None:
        ...
        self._connection = await aiomysql.connect(host=host, port=port, db=database, user=user, password=password)
    ...
    async def _connect_pymysql(self) -> None:
        ...
        self._connection = await loop.run_in_executor(
            None,
            lambda: pymysql.connect(host=host, port=port, database=database, user=user, password=password),
        )
    ...
    async def _execute_query_aiomysql(self, query: str, params: dict[str, Any] | None) -> list[dict[str, Any]]:
    ...
    async def _execute_query_pymysql(self, query: str, params: dict[str, Any] | None) -> list[dict[str, Any]]:
    ...
    async def _execute_command_aiomysql(self, command: str, params: dict[str, Any] | None) -> int:
    ...
    async def _execute_command_pymysql(self, command: str, params: dict[str, Any] | None) -> int:
