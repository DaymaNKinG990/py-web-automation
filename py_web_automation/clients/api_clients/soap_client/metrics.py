"""
Performance metrics collection for SOAP client.

This module provides metrics collection for monitoring SOAP operation performance,
...
class Metrics:
    """
    Performance metrics collector for SOAP operations.

    Collects and aggregates metrics about SOAP operations including:
    - Operation count and success/error rates
    - Latency statistics (min, max, average)
    - Error breakdown by type (SOAP faults, etc.)
    - Timestamp tracking
    ...
    def record_request(
        ...
        """
        Record a SOAP operation metric.
        ...
        Example:
            ...
            >>> metrics.record_request(success=False, latency=0.1, error_type="soap_fault_Server")
        """
