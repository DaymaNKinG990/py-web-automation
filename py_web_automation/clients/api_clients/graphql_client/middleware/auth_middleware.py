"""
Authentication middleware for GraphQL client.
...
class AuthMiddleware(Middleware):
    """
    Middleware for automatic authentication header injection in GraphQL requests.
    ...
    Example:
        ...
        >>> from py_web_automation.clients.graphql_client.middleware import AuthMiddleware
