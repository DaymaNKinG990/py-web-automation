"""
Performance metrics collection for GraphQL operations.

This module provides metrics collection for monitoring GraphQL operation performance,
...
class Metrics:
    """
    Performance metrics collector for GraphQL operations.

    Collects and aggregates metrics about GraphQL operations including:
    - Operation count and success/error rates
    - Latency statistics (min, max, average)
    - Error breakdown by type
    - Timestamp tracking

    Attributes:
        request_count: Total number of operations
        success_count: Number of successful operations
        error_count: Number of failed operations
        total_latency: Sum of all operation latencies
        ...
        last_request_time: Timestamp of last operation
    """
    ...
    def record_request(
        ...
        """
        Record a GraphQL operation metric.
    ...
    def avg_latency(self) -> float:
        ...
        Returns:
            Average latency in seconds, or 0.0 if no operations
        """
    ...
    def success_rate(self) -> float:
        ...
        Returns:
            Success rate as percentage (0-100), or 0.0 if no operations
        """
        if self.request_count == 0:
            return 0.0
    ...
    def error_rate(self) -> float:
        ...
        Returns:
            Error rate as percentage (0-100), or 0.0 if no operations
        """
        if self.request_count == 0:
            return 0.0
    ...
    def operations_per_second(self) -> float:
        ...
        Returns:
            Average operations per second since start, or 0.0 if no operations
        """
        if self.request_count == 0:
            return 0.0
    ...
    def requests_per_second(self) -> float:
        """
        Calculate requests per second (alias for operations_per_second).
    ...
    def get_summary(self) -> str:
        ...
        """
        return (
            f"Operations: {self.request_count} | "
            ...
            f"OPS: {self.operations_per_second:.2f}"
        )
