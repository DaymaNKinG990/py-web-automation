...
async def main():
    ...
    try:
        ...
        async with ApiClient(base_url, config) as api:
            ...
            print(f"   Failed requests: {metrics.failure_count}")
        ...
        class ResponseModifierMiddleware(Middleware):
            ...
            async def process_response(self, context: ResponseContext) -> None:
                # Add custom metadata
                context.metadata["processed_by"] = "ResponseModifierMiddleware"
                context.metadata["timestamp"] = "1234567890"
